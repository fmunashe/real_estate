...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Update Client Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="/client/{{ $client[0]->id }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email"
                                           ...
                                           name="email"
                                           id="email"
                                           value="{{ old('email') ?? $client[0]->email}}"
                                           placeholder="Enter client email" readonly>
                                    @if ($errors->has('email'))
                                ...
                                <div class="form-group">
                                    ...
                                    name="phone" 
                                    id="phone"
                                    value="{{ old('phone') ?? $client[0]->phone}}"
                                ...
                                <div class="form-group">
                                    ...
                                    name="national_id" 
                                    id="national_id"
                                    value="{{ old('national_id') ?? $client[0]->national_id}}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                name="spouse" 
                                id="spouse"
                                value="{{ old('spouse') ?? $client[0]->spouse }}"
                            ...
                            <div class="form-group">
                                ...
                                name="spouse_phone" 
                                id="spouse_phone"
                                value="{{ old('spouse_phone') ?? $client[0]->spouse_phone }}"
                            ...
                            <div class="form-group">
                                ...
                                name="spouse_address" 
                                id="spouse_address"
                                value="{{ old('spouse_address') ?? $client[0]->spouse_address }}"
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('spouse_national_id') ?? $client[0]->spouse_national_id }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm {{ $errors->has('marital_status') ? ' is-invalid' : '' }}"
                                    ...
                                    @foreach ($status as $key => $value)
                                        <option value="{{ $key }}" {{ ($key == $client[0]->marital_status) ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                   ...
                                   name="address"
                                   id="address"
                                   value="{{ old('address') ?? $client[0]->address}}"
                                   placeholder="Enter client address">{{ old('address') ?? $client[0]->address}}</textarea>
                ...
                <div class="card-footer">
                    <button type="submit" class="form-control btn btn-outline-dark">Update Client Details</button>
                </div>
            </form>
        </div>
    </div>
